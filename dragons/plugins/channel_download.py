...
from . import drgub, edit_or_reply
...
@drgub.drg_cmd(
    ...
    info={
        ...
        "examples": "{tr}getc 10 @teamkinguserbot",
    },
)
async def get_media(event):
    drgty = event.pattern_match.group(1)
    limit = int(drgty.split(" ")[0])
    channel_username = str(drgty.split(" ")[1])
...
@drgub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}geta @teamkinguserbot",
    },
)
async def get_media(event):
