...
@drgub.drg_cmd(
    ...
    info={
        ...
        "var name": "[list of vars](https://dragonsuserbot.gitbook.io/dragonsuserbot/data-vars-setup)",
        "usage": [
...
@drgub.drg_cmd(
    ...
    info={
        "header": "To customize your Dragons-Userbot.",
        "options": {
...
async def custom_dragonsuserbot(event):
    "To customize your Dragons-Userbot."
    reply = await event.get_reply_message()
    text = None
    if reply:
        text = reply.text
...
@drgub.drg_cmd(
    ...
    info={
        "header": "To delete costomization of your Dragons-Userbot.",
        "options": {
...
async def custom_drguserbot(event):
    "To delete costomization of your Dragons-Userbot."
    input_str = event.pattern_match.group(1)
    if input_str == "pmpermit":
