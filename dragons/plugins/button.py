...
# button post makker for Dragons-Userbot thanks to uniborg for the base
...
from . import drgub, edit_delete, reply_id
...
@drgub.drg_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [Dragons-Userbot]<buttonurl:https://t.me/dragons:same> [support]<buttonurl:https://t.me/kinguserbotsupport>",
    },
)
async def _(event):
...
@drgub.drg_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test [google]<buttonurl:https://www.google.com> [Dragons-Userbot]<buttonurl:https://t.me/dragons:same> [support]<buttonurl:https://t.me/kinguserbotsupport>",
    },
)
async def _(event):
    ...
    if not markdown_note:
        return await edit_delete(event, "`what text should i use in button post`")
    drginput = "Inline buttons " + markdown_note
    results = await event.client.inline_query(Config.TG_BOT_USERNAME, drginput)
