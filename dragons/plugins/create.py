...
@drgub.drg_cmd(
    ...
    info={
        ...
        "examples": "{tr}create b dragons-userbot",
    },
)
async def _(event):
    ...
    if type_of_group == "c":
        descript = "This is a Test Channel created using dragons-userbot"
    else:
        descript = "This is a Test Group created using dragons-userbot"
    if type_of_group == "g":
        try:
