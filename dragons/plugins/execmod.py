from dragons import drgtub

from ..core.managers import edit_delete, edit_or_reply
from ..helpers.utils import _drgutils, parse_pre, yaml_format
...
async def _(event):
    ...
    cmd = "ls dragons/plugins"
    o = (await _drgutils.runcmd(cmd))[0]
    OUTPUT = f"**[Dragon's](tg://need_update_for_some_feature/) PLUGINS:**\n{o}"
...
async def _(event):
    ...
    o = (await _drgutils.runcmd(cmd))[0]
    OUTPUT = (
        f"**[Dragon's](tg://need_update_for_some_feature/) Environment Module:**\n\n\n{o}"
    )
    await edit_or_reply(event, OUTPUT)
