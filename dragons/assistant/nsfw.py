...
@drgub.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@drgub.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@drgub.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
